defmodule Exproject.VehiclesTest do
  use Exproject.DataCase

  alias Exproject.Vehicles

  describe "vehicles" do
    alias Exproject.Vehicles.Vehicle

    import Exproject.VehiclesFixtures
